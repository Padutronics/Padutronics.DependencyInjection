...
[TestFixture]
internal sealed class Implementation_one_and_two_parameter_constructors_with_the_first_parameter_of_different_type_and_optional_parameter_in_the_second_one
{
    ...
    private sealed class Service : IService
    {
        ...
        public Service(IDependency2 dependency2, IDependency3? dependency3 = null)
        {
    ...
    [Test]
    public void Two_parameter_constructor_is_selected_if_second_dependency_is_registered()
    {
        // Arrange.
        var containerBuilder = new ContainerBuilder();
        containerBuilder.For<IService>().Use<Service>();
    ...
    [Test]
    public void Two_parameter_constructor_is_selected_if_first_and_second_dependency_is_registered()
    {
        // Arrange.
        var containerBuilder = new ContainerBuilder();
        containerBuilder.For<IService>().Use<Service>();
