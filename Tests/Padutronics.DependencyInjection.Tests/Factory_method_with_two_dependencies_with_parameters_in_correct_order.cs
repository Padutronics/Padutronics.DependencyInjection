...
[TestFixture]
internal sealed class Factory_method_with_two_dependencies_with_parameters_in_correct_order
{
    ...
    {
        IService CreateService(IDependency1 dependency1, IDependency2 dependency2);
    }
    ...
    public void Instance_is_created_using_provided_dependencies()
    {
        ...
        IService service = serviceFactory.CreateService(dependency1, dependency2);
