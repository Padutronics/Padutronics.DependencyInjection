...
[TestFixture]
internal sealed class Resolve_open_generic_with_singleton_lifetime
{
    ...
    public void Different_instances_are_resolved_on_each_service_request_of_different_type_when_implementation_is_registered_with_transient_lifetime()
    {
        ...
        containerBuilder.For(typeof(IService<>)).Use(typeof(Service<>)).SingleInstance();
    ...
    [Test]
    public void The_same_instance_is_resolved_on_each_service_request_of_the_same_type_when_implementation_is_registered_with_transient_lifetime()
    {
        // Arrange.
        var containerBuilder = new ContainerBuilder();
        containerBuilder.For(typeof(IService<>)).Use(typeof(Service<>)).SingleInstance();
