...
[TestFixture]
internal sealed class Implementation_multiple_one_parameter_constructors_with_optional_parameter_in_one
{
    ...
    private sealed class Service : IService
    {
        ...
        public Service(IDependency2? dependency2 = null)
        {
    ...
    [Test]
    public void The_second_constructor_with_one_parameter_is_selected_if_none_of_dependencies_are_registered()
    {
        // Arrange.
        var containerBuilder = new ContainerBuilder();
        containerBuilder.For<IService>().Use<Service>();
    ...
    [Test]
    public void Exception_is_thrown_if_dependency_for_the_first_constructor_is_registered()
    {
        // Arrange.
        var containerBuilder = new ContainerBuilder();
        containerBuilder.For<IService>().Use<Service>();
